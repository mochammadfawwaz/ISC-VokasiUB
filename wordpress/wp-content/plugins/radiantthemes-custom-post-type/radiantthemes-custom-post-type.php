...
function radiantthemes_custom_posts_init() {
	...
	// Register the "Custom Footers" custom post type.
	$custom_footer_labels = array(
		'name'                  => __( 'Footers', 'radiantthemes-custom-post-type' ),
		'singular_name'         => __( 'Footer', 'radiantthemes-custom-post-type' ),
		'menu_name'             => __( 'Custom Footers', 'radiantthemes-custom-post-type' ),
		'name_admin_bar'        => __( 'Footer', 'radiantthemes-custom-post-type' ),
		'add_new'               => __( 'Add New', 'radiantthemes-custom-post-type' ),
		'add_new_item'          => __( 'Add New', 'radiantthemes-custom-post-type' ),
		'new_item'              => __( 'New Footer', 'radiantthemes-custom-post-type' ),
		'edit_item'             => __( 'Edit Footer', 'radiantthemes-custom-post-type' ),
		'view_item'             => __( 'View Footer', 'radiantthemes-custom-post-type' ),
		'all_items'             => __( 'All Footers', 'radiantthemes-custom-post-type' ),
		'search_items'          => __( 'Search Footers', 'radiantthemes-custom-post-type' ),
		'not_found'             => __( 'No Footers found.', 'radiantthemes-custom-post-type' ),
		'not_found_in_trash'    => __( 'No Footers found in Trash.', 'radiantthemes-custom-post-type' )
	);

	$custom_footer_args = array(
		'labels'             => $custom_footer_labels,
		'public'             => true,
	...
	register_post_type('radiant_footer', $custom_footer_args);
}
...
function radiant_force_type_private($post) {
	if ($post['post_type'] == 'radiant_footer' && $post['post_status'] != 'trash') {
		$post['post_status'] = 'private';
	}
	return $post;
}
add_filter('wp_insert_post_data', 'radiant_force_type_private');
