...
function radiantthemes_page_add_custom_box() {
	...
	foreach ( $screens as $screen ) {
		add_meta_box(
			'page_sectionid', __( 'Page Details', 'radiantthemes-custom-post-type' ), 'radiantthemes_page_inner_custom_box', $screen
		);
	}
}
...
function radiantthemes_page_inner_custom_box( $post ) {
	...
	/*if($footercheck){
	$title = get_the_title($footercheck);
 	$title = str_replace('Private: ', '', $title);
 	}
	$default_footer = empty( $footercheck ) ? 'Default Footer' : $title;*/
	?>
	    ...
	    <div class="radiantthemes-page-options-body">
	        ...
	        <div class="radiantthemes-page-options-body-image-selector">
	            <ul id="RadiantThemesPageHeaderSelector">
	                <li class="header-default"><input type="radio" name="selectheader" value="default" <?php checked( $default_selectheader, 'default' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Default', 'radiantthemes-custom-post-type' ); ?></label></li>
    	            <li class="header-one"><input type="radio" name="selectheader" value="one" <?php checked( $vselectheader, 'one' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header One', 'radiantthemes-custom-post-type' ); ?></label></li>
    	            <li class="header-two"><input type="radio" name="selectheader" value="two" <?php checked( $vselectheader, 'two' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Two', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-three"><input type="radio" name="selectheader" value="three" <?php checked( $vselectheader, 'three' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Three', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-four"><input type="radio" name="selectheader" value="four" <?php checked( $vselectheader, 'four' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Four', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-five"><input type="radio" name="selectheader" value="five" <?php checked( $vselectheader, 'five' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Five', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-six"><input type="radio" name="selectheader" value="six" <?php checked( $vselectheader, 'six' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Six', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-seven"><input type="radio" name="selectheader" value="seven" <?php checked( $vselectheader, 'seven' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Seven', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-eight"><input type="radio" name="selectheader" value="eight" <?php checked( $vselectheader, 'eight' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Eight', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="header-nine"><input type="radio" name="selectheader" value="nine" <?php checked( $vselectheader, 'nine' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Header Nine', 'radiantthemes-custom-post-type' ); ?></label></li>
	            </ul>
	        </div>
	        <!-- radiantthemes-page-options-body-image-selector -->
	    </div>
	    ...
	    <div class="radiantthemes-page-options-body">
	        ...
	        <div class="radiantthemes-page-options-body-image-selector">
	            <ul id="RadiantThemesPageBannerSelector">
	                <li class="header-default"><input type="radio" name="bannercheck" value="defaultbannercheck" <?php checked( $default_bannercheck, 'defaultbannercheck' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Default', 'radiantthemes-custom-post-type' ); ?></label></li>
	                <li class="bannerbreadcumbs"><input type="radio" name="bannercheck" value="bannerbreadcumbs" <?php checked( $vbannercheck, 'bannerbreadcumbs' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Banner + Breadcumbs', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="banneronly"><input type="radio" name="bannercheck" value="banneronly" <?php checked( $vbannercheck, 'banneronly' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Only Banner', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="breadcumbsonly"><input type="radio" name="bannercheck" value="breadcumbsonly" <?php checked( $vbannercheck, 'breadcumbsonly' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'Only Breadcumbs', 'radiantthemes-custom-post-type' ); ?></label></li>
            		<li class="nobannerbreadcumbs"><input type="radio" name="bannercheck" value="nobannerbreadcumbs" <?php checked( $vbannercheck, 'nobannerbreadcumbs' ); ?> ><div class="image-holder"></div><label><?php esc_html_e( 'None', 'radiantthemes-custom-post-type' ); ?></label></li>
	            </ul>
	        </div>
	        <!-- radiantthemes-page-options-body-image-selector -->
	    </div>
	...
	<div id="RadiantThemesPageHeader" class="radiantthemes-page-options">
	    ...
	    <div class="radiantthemes-page-options-body">
	        ...
	        <div class="radiantthemes-page-options-body-image-selector">
	            ...
	            <?php $rf = get_posts( 'post_type="radiant_footer"&post_status="private"&numberposts=-1' );
