...
$output .= '<div class="rt-portfolio-box element-three row isotope">';
// WP_Query arguments.
global $wp_query;
$args = array(
	'post_type'      => 'portfolio',
	...
	while ( $my_query->have_posts() ) :
		...
		$output                     .= '">';
			$output                 .= '<div class="holder">';
				$output             .= '<img src="' . plugins_url( 'radiantthemes-addons/assets/images/Blank-Image-100x70.png' ) . '" alt="Blank Image" width="100" height="70">';
