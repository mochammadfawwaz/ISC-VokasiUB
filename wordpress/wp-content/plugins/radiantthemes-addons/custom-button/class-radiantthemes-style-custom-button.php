...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Custom_Button' ) ) {
	...
	class Radiantthemes_Style_Custom_Button extends WPBakeryShortCode {
		...
		public function radiantthemes_custom_button_style_func( $atts, $content = null, $tag ) {
			...
			$button_random_class = 'rt' . wp_rand();
			...
			if ( strlen( $url['url'] ) > 0 ) {
				...
				// HOVER STYLE ONE.
				if ( 'one' === $shortcode['button_hover_style'] ) { // NO OVERLAY.
					$output .= '';
				} elseif ( 'two' === $shortcode['button_hover_style'] ) { // HOVER STYLE TWO.
					$output .= '<div class="overlay"></div>';
				} elseif ( 'three' === $shortcode['button_hover_style'] ) { // HOVER STYLE THREE.
					$output .= '<div class="overlay"></div>';
				} elseif ( 'four' === $shortcode['button_hover_style'] ) { // HOVER STYLE FOUR.
					$output .= '';
				}
