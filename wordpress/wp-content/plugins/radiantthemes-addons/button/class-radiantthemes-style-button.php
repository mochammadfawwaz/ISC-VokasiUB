...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Button' ) ) {
	...
	class Radiantthemes_Style_Button extends WPBakeryShortCode {
		...
		public function __construct() {
			vc_map(
				array(
					...
					'icon'        => plugins_url( 'radiantthemes-addons/assets/icons/Button-Element-Icon.png' ),
		...
		public function radiantthemes_button_style_func( $atts, $content = null, $tag ) {
			...
			$theme_options_value = get_option( 'appon_theme_option' );
			...
			// HOVER STYLE ONE
			if ( 'one' === appon_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE TWO
			} elseif ( 'two' === appon_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE THREE
			} elseif ( 'three' === appon_global_var( 'button_hover_style', '', false ) ) {
				...
				// HOVER STYLE FOUR
			} elseif ( 'four' === appon_global_var( 'button_hover_style', '', false ) ) {
			...
			$output .= '<div class="radiantthemes-button hover-style-' . esc_attr( appon_global_var( 'button_hover_style', '', false ) ) . ' ' . $animation_classes . ' ' . esc_attr( $shortcode['extra_class'] ) . '" ' . $button_id . ' data-button-direction="' . $shortcode['align'] . '"';
