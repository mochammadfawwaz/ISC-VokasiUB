...
class Radiantthemes_Contact_Box_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			esc_html__( 'RadiantThemes Contact Box', 'appon' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Contact box for footer area.', 'appon' ),
			)
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'contacttitledata' ) ); ?>"><?php esc_html_e( 'Title:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'addressdata' ) ); ?>"><?php esc_html_e( 'Address:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phonenumber' ) ); ?>"><?php esc_html_e( 'Phone Number:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'emailid' ) ); ?>"><?php esc_html_e( 'Email ID:', 'appon' ); ?></label>
...
/**
 * [appon_contact_box_load_widget description]
 */
