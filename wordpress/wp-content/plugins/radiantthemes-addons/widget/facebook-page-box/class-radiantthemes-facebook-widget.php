 ...
 * Class Definition.
 */
class Radiantthemes_Facebook_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'radiantthemes_facebook_widget',
			// Widget name will appear in UI.
			esc_html__( 'RadiantThemes Facebook Page Box', 'appon' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for facebook box.', 'appon' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$pageurl          = ! empty( $instance['page-url'] ) ? $instance['page-url'] : esc_url( 'https://www.facebook.com/facebook' );
		$pagetabsevents   = esc_attr( $instance['page-tabs-events'] );
		$pagetabsmessages = esc_attr( $instance['page-tabs-messages'] );
		$width            = ! empty( $instance['width'] ) ? $instance['width'] : esc_attr( '340' );
		$height           = ! empty( $instance['height'] ) ? $instance['height'] : esc_attr( '500' );
		...
		?>
		<iframe src="https://www.facebook.com/plugins/page.php?href=<?php echo esc_url( $pageurl ); ?>&tabs=timeline,<?php echo esc_attr( $pagetabsevents ); ?>,<?php echo esc_attr( $pagetabsmessages ); ?>&width=<?php echo esc_attr( $width ); ?>&height=<?php echo esc_attr( $height ); ?>&small_header=<?php echo esc_attr( $smallheader ); ?>&adapt_container_width=<?php echo esc_attr( $acwidth ); ?>&hide_cover=<?php echo esc_attr( $hidecover ); ?>&show_facepile=<?php echo esc_attr( $showfacepile ); ?>" width="<?php echo esc_attr( $width ); ?>" height="<?php echo esc_attr( $height ); ?>"></iframe>
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-url' ) ); ?>"><?php esc_html_e( 'Page URL:', 'appon' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'page-url' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'page-url' ) ); ?>" type="url" value="<?php echo esc_url( $pageurl ); ?>" />
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page-tabs' ) ); ?>"><?php esc_html_e( 'Tabs to render i.e. events, messages(timeline is default):', 'appon' ); ?></label>
			...
			<label><?php esc_html_e( 'Events', 'appon' ); ?></label>
			...
			<label><?php esc_html_e( 'Messages', 'appon' ); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'small_header' ) ); ?>"><?php esc_html_e( 'Use the small header instead:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'adapt_container_width' ) ); ?>"><?php esc_html_e( 'Try to fit inside the container width:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php esc_html_e( 'Hide cover photo in the header:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_facepile' ) ); ?>"><?php esc_html_e( 'Show profile photos when friends like this:', 'appon' ); ?></label>
 ...
 */
function radiantthemes_load_widget() {
	register_widget( 'Radiantthemes_Facebook_Widget' );
}
add_action( 'widgets_init', 'radiantthemes_load_widget' );
