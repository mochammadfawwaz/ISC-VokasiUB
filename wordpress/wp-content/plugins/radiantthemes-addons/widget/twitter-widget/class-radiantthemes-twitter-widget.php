 ...
 * Class Definition.
 */
class Radiantthemes_Twitter_Widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			'radiantthemes_twitter_widget',
			// Widget name will appear in UI.
			esc_html__( 'RadiantThemes Twitter Widget', 'appon' ),
			// Widget description.
			array(
				'description' => esc_html__( 'Widget for twitter box.', 'appon' ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$username    = ! empty( $instance['username'] ) ? $instance['username'] : esc_html__( 'twitter', 'appon' );
		$maxtweets   = ! empty( $instance['maxtweets'] ) ? $instance['maxtweets'] : esc_html__( '5', 'appon' );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'appon' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'username' ) ); ?>" type="text" value="<?php echo esc_attr( $username ); ?>" />
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'maxtweets' ) ); ?>"><?php esc_html_e( 'No. of Maximum Tweets:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'enablelinks' ) ); ?>"><?php esc_html_e( 'Enable Links:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showuser' ) ); ?>"><?php esc_html_e( 'Show User:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showtime' ) ); ?>"><?php esc_html_e( 'Show Time:', 'appon' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'showimages' ) ); ?>"><?php esc_html_e( 'Show Images:', 'appon' ); ?></label>
 ...
 */
function radiantthemes_twitter_load_widget() {
	register_widget( 'Radiantthemes_Twitter_Widget' );
}
add_action( 'widgets_init', 'radiantthemes_twitter_load_widget' );
