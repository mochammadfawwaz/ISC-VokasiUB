	...
	class Radiantthemes_Style_Pricing_Table extends WPBakeryShortCode {
				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								esc_html__( 'Style One (Modern)', 'radiantthemes-addons' )     => 'one',
								esc_html__( 'Style Two (Creative)', 'radiantthemes-addons' )   => 'two',
								esc_html__( 'Style Three (Classic)', 'radiantthemes-addons' )  => 'three',
		...
		public function radiantthemes_pricing_table_style_func( $atts, $content = null, $tag ) {
			...
			if($shortcode['pricing_table_color']) {
    			$custom_css = ".rt-pricing-table.element-three.{$random_class} > .holder > .more .btn,
                ...
                .rt-pricing-table.element-two.{$random_class} > .holder > .heading,
                .rt-pricing-table.element-two.{$random_class} > .holder > .more .btn,
                .rt-pricing-table.element-three.spotlight.{$random_class} > .holder > .heading,
                .rt-pricing-table.element-three.spotlight.{$random_class} > .holder > .pricing,
