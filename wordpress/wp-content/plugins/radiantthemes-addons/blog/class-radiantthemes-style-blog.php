...
if ( class_exists( 'WPBakeryShortCode' ) && ! class_exists( 'Radiantthemes_Style_Blog' ) ) {
	...
	class Radiantthemes_Style_Blog extends WPBakeryShortCode {
		...
		public function __construct() {
			vc_map(
				array(
					...
					'icon'        => plugins_url( 'radiantthemes-addons/assets/icons/Blog-Element-Icon.png' ),
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Masonry Classic No Excerpt)', 'radiantthemes-addons' )     => 'one',
								esc_html__( 'Style Two (Classic Overlay)', 'radiantthemes-addons' )                => 'two',
								esc_html__( 'Style Three (Alternate Grid)', 'radiantthemes-addons' )               => 'three',
								esc_html__( 'Style Four (Classic Top Image)', 'radiantthemes-addons' )             => 'four',
								esc_html__( 'Style Five (Masonry Classic With Excerpt)', 'radiantthemes-addons' )  => 'five',
								esc_html__( 'Style Six (Classic Top Image With Arrow)', 'radiantthemes-addons' )   => 'six',
								esc_html__( 'Style Seven (Zig-Zag With First Box)', 'radiantthemes-addons' )       => 'seven',
								esc_html__( 'Style Eight (Blog Box 3D Hover)', 'radiantthemes-addons' )            => 'eight',
								esc_html__( 'Style Nine (Simple No Excerpt)', 'radiantthemes-addons' )             => 'nine',
								esc_html__( 'Style Ten (Simple With Date Highlight)', 'radiantthemes-addons' )     => 'ten',
							),
							'std'        => 'one',
						),
						array(
							...
							'value'      => array(
							    esc_html__( 'No Hover', 'radiantthemes-addons' )                   => 'one',
								esc_html__( 'Style One (3D Tilt Style)', 'radiantthemes-addons' )  => 'two',
								esc_html__( 'Style Two (Slide Up)', 'radiantthemes-addons' )       => 'three',
							),
							'std'        => 'one',
							'dependency' => array(
						...
						array(
							...
							'param_name'  => 'blog_color',
							'description' => esc_html__( 'Set your blog color scheme. (If not selected, it will take theme default color)', 'radiantthemes-addons' ),
						),
						array(
							'type'       => 'dropdown',
		...
		public function radiantthemes_blog_style_func( $atts, $content = null, $tag ) {
			...
			// ADD CUSTOM CSS.
			$custom_css = $shortcode['blog_color'] ? '.blog.element-one.'.$random_class.' .blog-item > .holder > .data ul.meta-data > li.category,
            .blog.element-one.'.$random_class.' .blog-item > .holder > .data .btn,
			.blog.element-three.'.$random_class.' .blog-item > .holder .data > .table > .table-cell ul.meta-data > li.category,
			.blog.element-four.'.$random_class.' .blog-item > .holder .data .title a:hover{
			    color: '.$shortcode['blog_color'].' ;
			}
			.blog.element-one.'.$random_class.' .blog-item > .holder > .data .btn:before,
			.blog.element-four.'.$random_class.' .blog-item > .holder:after{
			    background-color: '.$shortcode['blog_color'].' ;
			}' : '';
			...
			if ( 'false' == $shortcode['blog_allow_carousel'] ) {
		        if ( 'one' == $shortcode['style_variation'] ) {
			        $output .= '<div class="blog element-' . $shortcode['style_variation'] . ' hover-style-' . $shortcode['hover_style'] . ' ';
    				$output .= $shortcode['extra_class'] . ' ' . esc_attr( $random_class ) . ' isotope" ' . $blog_id;
    				$output .= ' data-row-items="';
    				$output .= esc_attr( $shortcode['blog_no_row_items'] ) . '"';
    				$output .= '>';
			    } else {
			        $output .= '<div class="blog element-' . $shortcode['style_variation'] . ' hover-style-' . $shortcode['hover_style'] . ' ';
    				$output .= $shortcode['extra_class'] . ' ' . esc_attr( $random_class ) . '" ' . $blog_id;
    				$output .= ' data-row-items="';
    				$output .= esc_attr( $shortcode['blog_no_row_items'] ) . '"';
    				$output .= '>';
			    }
