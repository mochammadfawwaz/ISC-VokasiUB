		...
		public function __construct() {
			vc_map(
				array(
					...
					'icon'        => plugins_url( 'radiantthemes-addons/assets/icons/Clients-Element-Icon.png' ),
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Style Two (Boxed Colored)', 'radiantthemes-addons' )                => 'two',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Keep Link', 'radiantthemes-addons' ),
							'param_name' => 'clients_allow_keep_link',
							'value'      => array(
								esc_html__( 'Yes', 'radiantthemes-addons' ) => 'true',
								esc_html__( 'No', 'radiantthemes-addons' )  => 'false',
							),
		...
		public function radiantthemes_clients_style_func( $atts, $content = null, $tag ) {
			...
			if ( $query->have_posts() ) {
				while ( $query->have_posts() ) {
					...
					if( 'true' === $shortcode['clients_allow_keep_link'] && get_post_meta( get_the_ID(), 'clientlink', true ) ) {
