	...
	class Radiantthemes_Style_Team extends WPBakeryShortCode {
				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Overlay Name and Profession) - Small', 'radiantthemes-addons' )  => 'one',
								esc_html__( 'Style Two (Overlay Name and Profession) - Large', 'radiantthemes-addons' )  => 'two',
								esc_html__( 'Style Three (B&W To Colored)', 'radiantthemes-addons' )                     => 'three',
								esc_html__( 'Style Four (B&W With Boxed Details)', 'radiantthemes-addons' )              => 'four',
							),
							'std'        => 'one',
						),
						array(
		...
		public function radiantthemes_team_style_func( $atts, $content = null, $tag ) {
			...
			if ( 'false' == $shortcode['team_allow_carousel'] ) {
				...
				$output .= ' ' . $shortcode['extra_class'] . '"  ' . $team_id;
