...
<footer class="wraper_footer style-default">
	...
	<?php
if (!appon_global_var('hide-footer-widget', '', false)) {
    $footer_widgets_count = 0;
    for ($j = 1;$j <= 4;$j++) {
        if (is_active_sidebar('appon-footer-area-' . $j)) {
	...
	<div class="wraper_footer_main">
        ...
        for ($j = 1;$j <= 4;$j++) {
            if (is_active_sidebar('appon-footer-area-' . $j)) {
                ...
                dynamic_sidebar('appon-footer-area-' . $j);
                echo '</div>
    									 </div>';
            }
        }
			...
			<div class="row footer_copyright">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="footer_copyright">
						<p><?php echo wp_kses_post(appon_global_var('footer_one_copyright_text', '', false)); ?></p>
					</div>
					<!-- footer_copyright -->
				</div>
			</div>
