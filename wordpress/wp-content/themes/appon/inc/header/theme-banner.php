...
if ( is_front_page() && is_home() ) { ?>
	...
	<div class="wraper_inner_banner">
		...
		<?php if ( ! ( is_front_page() && is_home() ) && ! is_page() ) : ?>
			<?php if ( function_exists( 'appon_breadcrumbs' ) ) : ?>
...
<?php } elseif ( is_front_page() ) { ?>
	...
	<?php } ?>
		<?php
		if (
			( 'Banner-With-Breadcrumb' === appon_global_var( 'short-header', '', false ) ) ||
			( 'Banner-only' === appon_global_var( 'short-header', '', false ) )
		) {
			?>
		<!-- wraper_inner_banner_main -->
			<div class="wraper_inner_banner_main">
			...
			if (
				( 'Banner-With-Breadcrumb' === appon_global_var( 'short-header', '', false ) ) ||
				( 'breadcrumb-only' === appon_global_var( 'short-header', '', false ) )
			) {
				?>
			<!-- wraper_inner_banner_breadcrumb -->
			<div class="wraper_inner_banner_breadcrumb">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_breadcrumb">
								<?php
								if ( function_exists( 'appon_breadcrumbs' ) ) {
									appon_breadcrumbs();
								}
								?>
							</div>
...
<?php } elseif ( class_exists( 'Tribe__Events__Main' ) && ( is_singular( 'tribe_events' ) || ( tribe_is_past() || tribe_is_upcoming() && ! is_tax() ) || ( tribe_is_month() && ! is_tax() ) || ( tribe_is_day() && ! is_tax() ) ) ) { ?>
		<!-- wraper_header_bannerinner -->
		<?php
		if ( appon_global_var( 'event_banner_image', 'url', true ) ) {
			$event_banner_image_link = esc_url( appon_global_var( 'event_banner_image', 'url', true ) );
			?>
		...
		<?php } ?>
			<?php
			if (
			( 'banner-breadcumbs' == appon_global_var( 'events_banner_details', '', false ) ) ||
			( 'banner-only' === appon_global_var( 'events_banner_details', '', false ) )
			) {
				?>
			<!-- wraper_inner_banner_main -->
			<div class="wraper_inner_banner_main">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								<?php
								if ( empty( appon_global_var( 'event_banner_title', '', false ) ) &&
									empty( appon_global_var( 'event_banner_subtitle', '', false ) ) ) :
									?>
									<p class="title">
										<?php echo esc_html( get_bloginfo( 'name' ) ); ?>
									</p>
								...
								<?php else : ?>
									<?php if ( appon_global_var( 'event_banner_title', '', false ) ) { ?>
									<p class="title">
										<?php echo esc_html( appon_global_var( 'event_banner_title', '', false ) ); ?>
									</p>
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Events', 'appon' ); ?>
									</p>
									<?php } ?>
									<?php if ( appon_global_var( 'event_banner_subtitle', '', false ) ) { ?>
									<p class="subtitle">
										<?php echo esc_html( appon_global_var( 'event_banner_subtitle', '', false ) ); ?>
									</p>
									<?php } ?>
								<?php endif; ?>
							</div>
			...
			if (
			( 'banner-breadcumbs' == appon_global_var( 'events_banner_details', '', false ) ) ||
			( 'breadcumbs-only' === appon_global_var( 'events_banner_details', '', false ) )
			) {
				?>
			<!-- wraper_inner_banner_breadcrumb -->
			<div class="wraper_inner_banner_breadcrumb">
								...
								<?php if ( is_category() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'Category Archives: %s', 'appon' ),
								...
								<?php elseif ( is_author() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'All posts by %s', 'appon' ),
								...
								<?php elseif ( is_tag() ) : ?>
									<p class="title">
										...
										printf(
											...
											esc_html__( 'Tag Archives: %s', 'appon' ),
								...
								<?php elseif ( is_archive() ) : ?>
									<p class="title">
										...
										if ( is_day() ) :
											printf(
												// translators: Date.
												esc_html__( 'Daily Archives: %s', 'appon' ),
												get_the_date()
											);
										elseif ( is_month() ) :
											printf(
												// translators: Month and Date.
												esc_html__( 'Monthly Archives: %s', 'appon' ),
												get_the_date( _x( 'F Y', 'monthly archives date format', 'appon' ) )
											);
										elseif ( is_year() ) :
											printf(
												// translators: Month Date, Year.
												esc_html__( 'Yearly Archives: %s', 'appon' ),
												get_the_date( _x( 'Y', 'yearly archives date format', 'appon' ) )
											);
										else :
											esc_html__( 'Archives', 'appon' );
										endif;
										?>
									</p>
								<?php else : ?>
...
<?php } elseif ( is_search() ) { ?>
		...
		?>
		<?php
		if ( appon_global_var( 'search_page_banner_image', 'url', true ) ) {
			$search_page_banner_image_link = esc_url( appon_global_var( 'search_page_banner_image', 'url', true ) );
			?>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="inner_banner_main">
								<?php
								if ( empty( appon_global_var( 'search_page_banner_title', '', false ) ) &&
									empty( appon_global_var( 'search_page_banner_subtitle', '', false ) ) ) :
									?>
									<p class="title">
										<?php echo esc_html( get_bloginfo( 'name' ) ); ?>
									</p>
								...
								<?php else : ?>
									<?php if ( appon_global_var( 'search_page_banner_title', '', false ) ) { ?>
									<p class="title">
										<?php echo esc_html( appon_global_var( 'search_page_banner_title', '', false ) ); ?>
									</p>
									<?php } else { ?>
									<p class="title">
										<?php echo esc_html__( 'Search', 'appon' ); ?>
									</p>
									<?php } ?>
									<?php if ( appon_global_var( 'search_page_banner_subtitle', '', false ) ) { ?>
									<p class="subtitle">
										<?php echo esc_html( appon_global_var( 'search_page_banner_subtitle', '', false ) ); ?>
									</p>
									<?php } ?>
								<?php endif; ?>
							</div>
