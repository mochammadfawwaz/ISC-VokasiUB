...
<!-- wraper_header -->
<?php if ( true == appon_global_var( 'header_seven_floating', '', false ) ) { ?>
	<header class="wraper_header style-seven floating-header">
<?php } else { ?>
	<header class="wraper_header style-seven static-header">
<?php } ?>
	<!-- wraper_header_main -->
	<?php if ( true == appon_global_var( 'header_seven_sticky', '', false ) ) { ?>
	...
	<?php } ?>
		<div class="container-fluid">
			...
			<div class="header_main">
				<?php if ( appon_global_var( 'header_seven_logo', 'url', true ) ) { ?>
					<!-- brand-logo -->
					<div class="brand-logo">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( appon_global_var( 'header_seven_logo', 'url', true ) ); ?>" alt="<?php echo esc_attr( appon_global_var( 'header_seven_logo', 'alt', true ) ); ?>"></a>
					</div>
					<!-- brand-logo -->
				<?php } ?>
			    <!-- header-flexi-menu -->
