		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				...
				<div class="team-profilebuzz-contactcard">
					...
					?>
					<hr>
					<h3><?php echo esc_html__( 'Qualification', 'appon' ); ?></h3>
					<?php if ( get_post_meta( get_the_ID(), 'qualification', true ) ) { ?>
						<p><?php echo esc_html( get_post_meta( get_the_ID(), 'qualification', true ) ); ?></p>
					<?php } ?>
					<h3><?php echo esc_html__( 'Contact Info', 'appon' ); ?></h3>
					<!-- contact -->
					<ul class="contact">
						<?php if ( get_post_meta( get_the_ID(), 'phone', true ) ) { ?>
							<li class="phone"><i class="fa fa-phone"></i> <a href="tel:<?php echo esc_html( get_post_meta( get_the_ID(), 'phone', true ) ); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_attr__( 'Make a Call', 'appon' ); ?>"><?php echo esc_html( get_post_meta( get_the_ID(), 'phone', true ) ); ?></a></li>
						<?php } ?>
						<?php if ( get_post_meta( get_the_ID(), 'email', true ) ) { ?>
							<li class="email"><i class="fa fa-envelope"></i> <a href="mailto:<?php echo esc_html( get_post_meta( get_the_ID(), 'email', true ) ); ?>" data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_attr__( 'Send an Email', 'appon' ); ?>"><?php echo esc_html( get_post_meta( get_the_ID(), 'email', true ) ); ?></a></li>
						<?php } ?>
					</ul>
					<!-- contact -->
					<!-- social -->
