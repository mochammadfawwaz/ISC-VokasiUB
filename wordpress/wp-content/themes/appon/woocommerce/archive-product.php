	...
	<?php } else { ?>
		...
		<div class="wraper_shop_main">
			<div class="container">
				<!-- row -->
				<div class="row">
					<?php if ( 'shop-nosidebar' === appon_global_var( 'shop-sidebar', '', false ) ) { ?>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<?php } else { ?>
						<?php if ( 'shop-leftsidebar' === appon_global_var( 'shop-sidebar', '', false ) ) { ?>
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
						<?php } elseif ( 'shop-rightsidebar' === appon_global_var( 'shop-sidebar', '', false ) ) { ?>
